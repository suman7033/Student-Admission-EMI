...
const DocumentAttached2 = ({ filteredData }) => {
  ...
  return (
    <div className="bg-white px-2  my-4 rounded-lg shadow-md">
      {PooupView && <Pooup />}
                ...
                <tr key={index}>
                  ...
                  <td>
                    <button
                      className="py-1 px-8 text-white rounded-md bg-[#637D9B] hover:bg-[#546B8C] transition"
                      onClick={() =>
                        ViewHandler("Front Aadhar Card", val.frontAadhar)
                      }
                    >
                      View
                    </button>
                  ...
                  <td>
                    <button
                      className="py-1 px-8 text-white rounded-md bg-[#637D9B] hover:bg-[#546B8C] transition"
                      onClick={() =>
                        ViewHandler("Back Aadhar Card", val.backAadhar)
                      }
                    >
                      View
                    </button>
...
export default DocumentAttached2;
